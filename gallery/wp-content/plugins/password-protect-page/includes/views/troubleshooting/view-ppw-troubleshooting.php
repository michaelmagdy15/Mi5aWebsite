                ...
                <td>
                    <div class="ppw_troubleshoot_checklist">
                        <ul>
                            ...
                            <li style="list-style: none"><?php _e( 'By default, both our Free and Pro versions ', PPW_Constants::DOMAIN ) ?>
                ...
                <td>
                    <div class="ppw-collapse-question">
                        <div class="ppw-collapse-title">
                            <?php _e( 'What if I want to show excerpts & featured images of protected content?' , PPW_Constants::DOMAIN ) ?>
                        </div>
